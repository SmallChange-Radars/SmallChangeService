...
public class TradeController {
	...
	public ResponseEntity<List<Trade>> getTradeActivity(@AuthenticationPrincipal UserDetailsImpl userDetails,@RequestParam(required = false) String q,
		...
		try {
			...
			List<Trade> tradeHistory = tradeService.getTradeActivityByClientId(userDetails.getClientId(),q, _page, _limit, _sort, _order);
